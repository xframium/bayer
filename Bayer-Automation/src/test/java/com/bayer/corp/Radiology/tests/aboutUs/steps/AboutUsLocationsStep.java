...
public class AboutUsLocationsStep extends AbstractStep {

	public AboutUsLocationsStep() {
    ...
    protected boolean _executeStep(BayerWebDriver webDriver){
		...
		Eyes eyes=Util.initilizeEyesServer(webDriver, webDriver.getCurrentUrl(),"Radiology about us locations", "radiology-aboutus-locations", "radiology-aboutus-locations");
		
		WebDriverWait wait = new WebDriverWait(webDriver, 30);
		
		this.scrollAndTakeScreenShot("radiology.aboutus.locations.validate",eyes,webDriver,wait);
