...
public class AboutUsSolutionsStep extends AbstractStep {

	public AboutUsSolutionsStep() {
    ...
    protected boolean _executeStep(BayerWebDriver webDriver){
		...
		Eyes eyes=Util.initilizeEyesServer(webDriver, webDriver.getCurrentUrl(),"Radiology about us Solutions", "radiology-aboutus-solutions", "radiology-aboutus-solutions");
		
		WebDriverWait wait = new WebDriverWait(webDriver, 30);
		
		this.scrollAndTakeScreenShot("radiology.aboutus.solutions.validate",eyes,webDriver,wait);
