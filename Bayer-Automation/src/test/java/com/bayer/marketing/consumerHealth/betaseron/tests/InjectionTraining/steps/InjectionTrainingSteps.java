package com.bayer.marketing.consumerHealth.betaseron.tests.InjectionTraining.steps;
...
public class InjectionTrainingSteps extends AbstractStep
{

    public InjectionTrainingSteps()
    {
