package com.bayer.marketing.Amazon.ClaritinProducts.tests.AppliTools.steps;
...
public class ClaritinAppliStep extends AbstractStep
{
    ...
    public ClaritinAppliStep(String url, int parentRowNum)
    {
