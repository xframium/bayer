...
public class CoppertoneStep extends AbstractStep
{
    ...
    public CoppertoneStep(String url, int parentRowNum)
    {
    ...
    protected boolean _executeStep(BayerWebDriver webDriver){	
        ...
        try {
            ...
            BatchInfo drScholls = new BatchInfo("Coppertone");
           ...
           { 
        	   ...
        	   eyes.open(webDriver.asRemote(), "Coppertone Mobile Test1", "Coppertone Mobile Test" + webDriver.getCapabilities().getCapability("platformName"));
        	   
           }
           else {
        	   System.out.println("Pass else statement");
        	   eyes.open(webDriver.asRemote(), "Coppertone Web", "Coppertone" + webDriver.getCapabilities().getCapability("platformName"), new RectangleSize(1510,900)); 
