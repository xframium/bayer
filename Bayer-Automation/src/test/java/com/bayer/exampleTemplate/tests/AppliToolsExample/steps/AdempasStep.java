...
public class AdempasStep extends AbstractStep
{
    ...
    public AdempasStep(String url, int parentRowNum)
    {
    ...
    protected boolean _executeStep(BayerWebDriver webDriver){	
		...
		System.out.println("For loop");
	        ...
	        try {
			            ...
			            BatchInfo batchName = new BatchInfo("Adempas");
			           ...
			           { 
			        	   ...
			        	   eyes.open(webDriver.asRemote(), "AdempasStep", "AdempasPatient: " + webDriver.getCapabilities().getCapability("platformName"));
			        	   
			           }
			           else {
			        	   System.out.println("Pass else statement");
			        	   eyes.open(webDriver.asRemote(), "AdempasStep Web", "AdempasStep" + webDriver.getCapabilities().getCapability("platformName")+" Pagenumber:"+rowNumber, new RectangleSize(1510,900)); 
           ...
           try {
			...
			testResultHandler.downloadCurrentImages("H:/Personal Data/Applitools/Screenshots");
		} catch (Exception e) {
